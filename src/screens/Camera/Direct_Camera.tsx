...
import { Dimensions, Image, StyleSheet, Text, View, ScrollView, TouchableOpacity, Alert, Platform, KeyboardAvoidingView } from "react-native";
...
import Camera_Screen from "./CameraScreen";
...
//   if (new Date(currentDate).getTime() < threeDaysAway.getTime()) {
//     // Toast.error('Please select a date that is after 3 days from today.');

//     Toast.show({
//       type:'error',
//       text1:'Please select a date that is after 3 days from today'
//     })
          ...
          >
            <View style={{ marginTop: 15, marginBottom: 100 }}>
              <View>
                ...
                <Camera_Screen  onUploadComplete={handleUploadComplete}/>
