...
const Maintainence_Steps: React.FC<Props> = ({ navigation, route }) => {
        ...
        if (response.ok) {
            ...
            setorderid(data.Job_details.Order_Id)
              ...
              if(data.Job_details.phase==="Currently in Pick a Vendor Phase")
                ...
                if(data.Job_details.phase==="Currently in a Vendor Visit Phase" || data.Job_details.phase==="Quotes Created"|| data.Job_details.phase==="Decide Between Quotes" )
                    {
                        setphase2(true)
                        setphase3(true)
...
/>
    ...
    <TouchableOpacity style={{backgroundColor:'#B22235',width:80,height:30,borderRadius:5,alignItems:'center',justifyContent:'center',marginTop:10}} onPress={Go_To_Created_Job}>
...
/>
    ...
    <View>
        ...
        {
            phase2 &&
    <TouchableOpacity style={{backgroundColor:'#B22235',width:80,height:30,borderRadius:5,alignItems:'center',justifyContent:'center',marginTop:10}} onPress={Go_To_Select_Vendor}>
...
/>
    ...
    <TouchableOpacity style={{backgroundColor:'#B22235',width:80,height:30,borderRadius:5,alignItems:'center',justifyContent:'center',marginTop:10}} onPress={Go_To_Select_Quotes}>
...
/>
    ...
    <View>
        ...
        {
            phase4 &&
    <TouchableOpacity style={{backgroundColor:'#B22235',width:80,height:30,borderRadius:5,alignItems:'center',justifyContent:'center',marginTop:10}} onPress={Go_To_Payment}>
...

{
    ...
    <TouchableOpacity style={{backgroundColor:'#B22235',width:80,height:30,borderRadius:5,alignItems:'center',justifyContent:'center',marginTop:10}} onPress={Go_To_Chat}>
...
<View>

    {
        ...
        phase6 &&
<TouchableOpacity style={{backgroundColor:'#B22235',width:80,height:30,borderRadius:5,alignItems:'center',justifyContent:'center',marginTop:10}} onPress={Go_To_Review}>
...
export default Maintainence_Steps;
